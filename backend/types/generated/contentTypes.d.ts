...
export interface ApiGlobalGlobal extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    naglowek: Schema.Attribute.Component<'layout.naglowek', true> &
      Schema.Attribute.Required &
      ...
      >;
    publishedAt: Schema.Attribute.DateTime;
    stopka: Schema.Attribute.Component<'layout.stopka', true> &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMax<
        {
          min: 1;
...
export interface ApiHomeHome extends Struct.SingleTypeSchema {
  ...
  attributes: {
    blocks: Schema.Attribute.DynamicZone<
      ['elements.video', 'layout.promowane', 'layout.pytania']
    >;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiProduktyProdukty extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::produkty.produkty'
    > &
      Schema.Attribute.Private;
    opis: Schema.Attribute.RichText & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::produkty.produkty': ApiProduktyProdukty;
